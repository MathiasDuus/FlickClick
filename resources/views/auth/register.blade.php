            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="profile_image" class="col-md-4 col-form-label text-md-right">Upload profile picture</label>

                            <div class="col-md-6">
                                <input accept="image/*" id="uploadProfilePicture" type="file" class="form-control-file" name="profile_image">
                            </div>
                        </div>
